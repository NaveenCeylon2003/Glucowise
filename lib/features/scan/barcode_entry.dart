...
class _BarcodeEntryPageState extends State<BarcodeEntryPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Barcode Sugar Checker", style: TextStyle(fontWeight: FontWeight.bold)),
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _buildTextField(_barcodeController, "Enter Barcode", "e.g., 123456789", Icons.barcode_reader),
                      const SizedBox(height: 10),
                      ...
                      _isLoading
                        ...
                        child: ElevatedButton.icon(
                          ...
                          label: const Text("Calculate Sugar Content", style: TextStyle(color: Colors.white, fontSize: 18)),
